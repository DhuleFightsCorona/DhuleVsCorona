 <div id="step-1" class="active tab-pane step-content" style="">
  ...
  <label class="custom-control-label" for="customCheck1">Is there any pregnent womwn in family?</label>
                        ...
                        @if ($is_preg)
                            ...
                            <input wire:model='preg_count' type="number" class="form-control" id="preg-women" aria-describedby="preg-women"
  ...
  <label class="custom-control-label" for="customCheck2">Is there any new born member in family?</label>
                        ...
                        @if ($is_newborn)
                            <div class="form-group ">
                            <input wire:model='newborn_count' type="number" class="form-control" aria-describedby="preg-women"
                                placeholder="If yes please specify the count">
                            </div>    
                        @endif
                        ...
                        <div class="form-group ">
                          <label for="family">Number of total family members:</label>
                            <input wire:model='family_count' type="number" class="form-control" id="family" aria-describedby="family"
