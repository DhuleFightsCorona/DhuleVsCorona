        ...
        <div class="col-xl-12 col-lg-12 text-center">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="weight" name="weight" aria-describedby="weight" placeholder="0">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label for="height">Height (in cm)*:</label>
                        <input type="number" class="form-control" id="height" name="height" aria-describedby="height" placeholder="0">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label for="age">Age:</label>
                        <input type="number" class="form-control" id="age" name="age" aria-describedby="age" placeholder="0">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" id="yes" name="is_physically_challenged" class="custom-control-input">
                            <label class="custom-control-label" for="yes">Yes</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="no" name="is_physically_challenged" class="custom-control-input">
            ...
            <div class="form-group">
                <label for="sym2">Symptoms which are not listed above(specify if
                    any):</label>
                <input type="text" class="form-control" id="sym2" aria-describedby="sym2" placeholder="Symptoms">
            </div>

            <div class="form-group">
                <div data-children-count="1">
                    <label for="temp">Approximate Body temperature(in F):</label>
                    <input type="range" class="custom-range" id="temp" name="temp" min="97" max="105" value="99">
                </div>
