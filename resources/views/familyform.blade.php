...
@section('content')
    ...
    <section class="p-3">
        <div class="container">
          <form class="" id='' action="/familyform" method="post"  x-data="{is_medical_history:false}" >
            @csrf
            @method('POST')
              <div class="container tab-content" style="min-height: 158px;">
                  <div class="p-4 bg-primary-alt text-center">
                    <div class="col-xl-12 col-lg-12 text-center">
                    <h2  id='change10'>Health Details of family members</h2>
                    @if ($errors->any())
                    ...
                    <div class="form-group">
                                        <label for="family_name">Name of family Memeber*</label>
                                <input wire:model='family_name' type="text" class="form-control" id="family_name" name='family_name' value="{{old('family_name')}}"                                     placeholder="Name" required>
                ...
                <label class="custom-control-label" for="customCheck4" id='change13'>Are You Ready To Donate Blood?</label>
                            ...
                            <div class="row" id='change14'>
                                ...
                                <input wire:model='weight' type="number" class="form-control" id="weight" name='weight' value="{{old('weight')}}" aria-describedby="weight"
            ...
            <div class="row text-center">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select wire:ignore class="form-control" wire:model='is_physically_challenged' name="is_physically_challenged" required>
            ...
            <div class="form-group text-center">
                ...
                <select wire:ignore  class="form-control" name="symptoms[]" multiple required>
                ...
                <div class="col-lg-6" id='change24'>
                    <div class="form-group text-center">
                        ...
                        <div class="custom-control custom-radio">
                            <input wire:model='symptoms_condition' type="radio" id="prog1" name="symptoms_condition" value="Improved" class="custom-control-input">
                            <label class="custom-control-label" for="prog1">Improved</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input wire:model='symptoms_condition' type="radio" id="prog2" name="symptoms_condition" value="No Change" class="custom-control-input">
                            <label class="custom-control-label" for="prog2">No Change</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input wire:model='symptoms_condition' type="radio" id="prog3" name="symptoms_condition" value="Worsened" class="custom-control-input">
            ...
            <div class="col-lg-12">
                ...
                <div class="custom-control custom-checkbox mb-3 text-center">
                <input x-model="is_medical_history" name='is_medical_history' type="checkbox" class="custom-control-input" id="customCheck3">
            ...
            <template  x-if="is_medical_history">
            ...
            {{-- @endif --}}
            <button class="btn btn-primary text-center">Save</a>
